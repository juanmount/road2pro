      ...
      for (const forecast of allForecasts) {
        await client.query(
          ...
          [
            ...
            Math.round(forecast.elevationMeters),
            forecast.validTime,
            Math.round(forecast.forecastHour),
        ...
        for (const agreement of processed.modelAgreement) {
          await client.query(
            ...
            [
              ...
              agreement.ecmwfFreezingLevelM != null ? Math.round(agreement.ecmwfFreezingLevelM) : null,
              agreement.gfsFreezingLevelM != null ? Math.round(agreement.gfsFreezingLevelM) : null,
